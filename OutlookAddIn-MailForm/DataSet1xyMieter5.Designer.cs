...
ORDER BY PUB.Adresse.Name1, PUB.Adresse.Name2, PUB.xyMieter.Folgenummer";
            ...
            this._commandCollection[1].CommandText = "SELECT PUB.xyMieter.AdressNr, PUB.xyMieter.WohnNr, PUB.Adresse.Name1, PUB.Adresse" +
                ...
                ") AND (PUB.xyMieter.MandantNr = 1) AND \r\n                  (PUB.xyMieter.Unterne" +
                "hmen = ?) AND (PUB.xyMieter.WE = ?) AND (PUB.xyMieter.HausNr = ?)\r\nGROUP BY PUB." +
                "xyMieter.AdressNr, PUB.xyMieter.WohnNr, PUB.Adresse.Name1, PUB.Adresse.Name2, PU" +
                "B.Adresse.Ort, PUB.Adresse.Strasse, PUB.Adresse.EMail, \r\n                  PUB.A" +
                "dresse.PlzOrt, PUB.Adresse.PlzPostf, PUB.Adresse.Postfach, PUB.Adresse.Gebname, " +
                "PUB.Adresse.Geschlecht, PUB.Adresse.VPName1, PUB.Adresse.VPName2, \r\n            " +
                "      PUB.Adresse.Postleitzahl, PUB.Adresse.Ortname, PUB.xyMieter.HausNr, PUB.xy" +
                "Mieter.MandantNr, PUB.xyMieter.Unternehmen, PUB.xyMieter.WE, \r\n                 " +
                " PUB.xyMieter.Vertragadressnr\r\nORDER BY PUB.Adresse.Name1, PUB.Adresse.Name2, MA" +
                "X(PUB.xyMieter.Folgenummer)";
