...
ORDER BY PUB.Adresse.Name1, PUB.Adresse.Name2, PUB.xyMieter.Folgenummer";
            ...
            this._commandCollection[3].CommandText = "SELECT PUB.xyMieter.AdressNr, PUB.xyMieter.WohnNr, PUB.Adresse.Name1, PUB.Adresse" +
                ".Name2, PUB.Adresse.Ort, PUB.Adresse.Strasse, PUB.Adresse.EMail, \r\n             " +
                "     MAX(PUB.xyMieter.Folgenummer) AS FOLGENR, MAX(PUB.xyMieter.Auszugsdatum) AS" +
                " AUSZUG, MAX(PUB.xyMieter.Einzugsdatum) AS EINZUG, PUB.Adresse.PlzOrt, \r\n       " +
                "           PUB.Adresse.PlzPostf, PUB.Adresse.Postfach, PUB.Adresse.Gebname, PUB." +
                "Adresse.Geschlecht, PUB.Adresse.VPName1, PUB.Adresse.VPName2, PUB.Adresse.Postle" +
                "itzahl, \r\n                  PUB.Adresse.Ortname, PUB.xyMieter.HausNr, PUB.xyMiet" +
                "er.MandantNr, PUB.xyMieter.Unternehmen, PUB.xyMieter.WE, PUB.xyMieter.Vertragadr" +
                "essnr\r\nFROM     PUB.xyMieter, PUB.Adresse\r\nWHERE  PUB.xyMieter.AdressNr = PUB.Ad" +
                "resse.AdressNr AND (PUB.xyMieter.AdressNr <> 9999999) AND (PUB.xyMieter.xyBearbe" +
                "iter <> \'\"Ess, Ess\"\') AND \r\n                  (PUB.xyMieter.xyGeloescht <> - 1) " +
                "AND (PUB.xyMieter.AbrechnenBeko <> \'\"N\"\') AND (PUB.xyMieter.Vertragadressnr <> 0" +
                ") AND (PUB.xyMieter.MandantNr = 1) AND \r\n                  (PUB.xyMieter.WE = ?)" +
                " AND (PUB.xyMieter.Unternehmen = ?)\r\nGROUP BY PUB.xyMieter.AdressNr, PUB.xyMiete" +
                "r.WohnNr, PUB.Adresse.Name1, PUB.Adresse.Name2, PUB.Adresse.Ort, PUB.Adresse.Str" +
                "asse, PUB.Adresse.EMail, \r\n                  PUB.Adresse.PlzOrt, PUB.Adresse.Plz" +
                "Postf, PUB.Adresse.Postfach, PUB.Adresse.Gebname, PUB.Adresse.Geschlecht, PUB.Ad" +
                "resse.VPName1, PUB.Adresse.VPName2, \r\n                  PUB.Adresse.Postleitzahl" +
                ", PUB.Adresse.Ortname, PUB.xyMieter.HausNr, PUB.xyMieter.MandantNr, PUB.xyMieter" +
                ".WE, PUB.xyMieter.Vertragadressnr, \r\n                  PUB.xyMieter.Unternehmen\r" +
                "\nHAVING (PUB.xyMieter.HausNr = ?) AND (PUB.xyMieter.WohnNr = ?)\r\nORDER BY PUB.Ad" +
                "resse.Name1, PUB.Adresse.Name2, FOLGENR";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByIDS(DataSet1xyMieter.xyMieterDataTable dataTable, int WE, int Unternehmen, int HausNr, int WohnNr) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual DataSet1xyMieter.xyMieterDataTable GetDataBy(int WE, int Unternehmen, int HausNr, int WohnNr) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(WE));
            this.Adapter.SelectCommand.Parameters[1].Value = ((int)(Unternehmen));
            this.Adapter.SelectCommand.Parameters[2].Value = ((int)(HausNr));
