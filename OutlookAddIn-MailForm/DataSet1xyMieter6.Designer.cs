...
ORDER BY PUB.Adresse.Name1, PUB.Adresse.Name2, PUB.xyMieter.Folgenummer";
            ...
            this._commandCollection[1].CommandText = @"SELECT PUB.xyMieter.AdressNr, PUB.xyMieter.WohnNr, PUB.Adresse.Name1, PUB.Adresse.Name2, PUB.Adresse.Ort, PUB.Adresse.Strasse, PUB.Adresse.EMail, 
                  MAX(PUB.xyMieter.Folgenummer) AS FOLGENR, MAX(PUB.xyMieter.Auszugsdatum) AS AUSZUG, MAX(PUB.xyMieter.Einzugsdatum) AS EINZUG, PUB.Adresse.PlzOrt, 
                  PUB.Adresse.PlzPostf, PUB.Adresse.Postfach, PUB.Adresse.Gebname, PUB.Adresse.Geschlecht, PUB.Adresse.VPName1, PUB.Adresse.VPName2, PUB.Adresse.Postleitzahl, 
                  PUB.Adresse.Ortname
FROM     PUB.xyMieter, PUB.Adresse
WHERE  PUB.xyMieter.AdressNr = PUB.Adresse.AdressNr AND (PUB.xyMieter.AdressNr <> 9999999) AND (PUB.xyMieter.xyBearbeiter <> '""Ess, Ess""') AND 
...
GROUP BY PUB.xyMieter.AdressNr, PUB.xyMieter.WohnNr, PUB.Adresse.Name1, PUB.Adresse.Name2, PUB.Adresse.Ort, PUB.Adresse.Strasse, PUB.Adresse.EMail, 
                  PUB.Adresse.PlzOrt, PUB.Adresse.PlzPostf, PUB.Adresse.Postfach, PUB.Adresse.Gebname, PUB.Adresse.Geschlecht, PUB.Adresse.VPName1, PUB.Adresse.VPName2, 
                  PUB.Adresse.Postleitzahl, PUB.Adresse.Ortname
ORDER BY PUB.Adresse.Name1, PUB.Adresse.Name2";
